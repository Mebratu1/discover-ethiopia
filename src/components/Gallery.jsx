  ...
  return (
    <section id="gallery" className="bg-[#0a0a0a] py-28 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Masonry Grid */}
        <div ref={gridRef} className="reveal columns-2 sm:columns-3 lg:columns-4 gap-3 space-y-3">
          {filtered.map((img, i) => (
            <div
              key={i}
            ...
            >
              <img
                ...
                loading="lazy"
              />
              <div className="gallery-overlay absolute inset-0 bg-black/60 flex flex-col items-center justify-center gap-2">
